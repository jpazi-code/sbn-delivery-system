...
var ChipDelete = React3.forwardRef(function ChipDelete2(inProps, ref) {
  ...
  const chipContext = React3.useContext(ChipContext_default);
  const {
    variant = variantProp,
  ...
  return (0, import_jsx_runtime3.jsx)(SlotRoot, _extends({}, restOfRootProps, {
    children: children != null ? children : _Cancel || (_Cancel = (0, import_jsx_runtime3.jsx)(Cancel_default, {}))
  }));
});
...
var ListSubheader = React4.forwardRef(function ListSubheader2(inProps, ref) {
  ...
  const setSubheaderId = React4.useContext(ListSubheaderContext_default);
  React4.useEffect(() => {
    if (setSubheaderId) {
      setSubheaderId(id || "");
    }
...
var AutocompleteListbox = React5.forwardRef(function AutocompleteListbox2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAutocompleteListbox"
  });
  ...
  return (0, import_jsx_runtime5.jsx)(VariantColorProvider, {
    variant,
    color,
    children: (0, import_jsx_runtime5.jsx)(SlotRoot, _extends({}, rootProps, {
      children
    }))
  });
});
...
var AutocompleteOption = React6.forwardRef(function AutocompleteOption2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAutocompleteOption"
  });
...
var defaultRenderGroup = (params) => (0, import_jsx_runtime8.jsxs)(ListItem_default, {
  nested: true,
  children: [(0, import_jsx_runtime7.jsx)(ListSubheader_default, {
    sticky: true,
    children: params.group
  }), (0, import_jsx_runtime7.jsx)(List_default, {
...
var Autocomplete = React7.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const formControl = React7.useContext(FormControlContext_default);
    ...
    if (renderTags) {
      ...
      selectedOptions = value.map((option, index) => {
        ...
        return (0, import_jsx_runtime7.jsx)(Chip_default, {
          ...
          variant: "soft",
          color: "neutral",
          endDecorator: (0, import_jsx_runtime7.jsx)(ChipDelete_default, _extends({}, endDecoratorProps2), endDecoratorKey),
          sx: {
            minWidth: 0
          },
  ...
  if (limitTags > -1 && Array.isArray(selectedOptions)) {
    ...
    if (!focused && more > 0) {
      ...
      selectedOptions.push((0, import_jsx_runtime7.jsx)(SlotLimitTag, _extends({}, limitTagProps, {
  ...
  const defaultRenderOption = (optionProps, option) => {
    ...
    return (0, import_jsx_runtime7.jsx)(SlotOption, _extends({}, rest, {
      children: getOptionLabel(option)
    }), key);
  };
  ...
  const modifiers = React7.useMemo(() => [{
    name: "offset",
    options: {
      offset: [0, 4]
    }
  ...
  if (anchorEl) {
    var _props$slots;
    popup = (0, import_jsx_runtime7.jsx)(VariantColorProvider, {
      variant,
      color,
      children: (0, import_jsx_runtime7.jsx)(ListProvider_default, {
        ...
        children: (0, import_jsx_runtime8.jsxs)(SlotListbox, _extends({}, listboxProps, {
          ...
          }), loading && groupedOptions.length === 0 ? (0, import_jsx_runtime7.jsx)(SlotLoading, _extends({}, loadingProps, {
            children: loadingText
          })) : null, groupedOptions.length === 0 && !freeSolo && !loading ? (0, import_jsx_runtime7.jsx)(SlotNoOptions, _extends({}, noOptionsProps, {
  ...
  return (0, import_jsx_runtime8.jsxs)(React7.Fragment, {
    children: [(0, import_jsx_runtime8.jsxs)(SlotRoot, _extends({}, rootProps, {
      children: [startDecorator && (0, import_jsx_runtime7.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
        ...
        children: [selectedOptions, (0, import_jsx_runtime7.jsx)(SlotInput, _extends({}, inputProps))]
      })), endDecorator && (0, import_jsx_runtime7.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      })), hasClearIcon ? (0, import_jsx_runtime7.jsx)(SlotClearIndicator, _extends({}, clearIndicatorProps, {
        children: clearIcon
      })) : null, hasPopupIcon ? (0, import_jsx_runtime7.jsx)(SlotPopupIndicator, _extends({}, popupIndicatorProps, {
        children: popupIcon
      })) : null]
    })), popup]
  });
...
//# sourceMappingURL=chunk-A3AXQSZ7.js.map
