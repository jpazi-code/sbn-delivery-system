...
} from "./chunk-265D53FJ.js";
import {
  TabList_default,
  getTabListUtilityClass,
  tabListClasses_default
} from "./chunk-4QM42UAI.js";
import {
  AvatarGroup_default,
  Avatar_default,
...
import {
  ...
  listClasses_default,
  scopedVariables
} from "./chunk-NW2SJJ2O.js";
import {
  GroupListContext_default
} from "./chunk-TEII5KYX.js";
import "./chunk-H52TP7EX.js";
import {
  Option_default,
  getOptionUtilityClass,
  optionClasses_default
} from "./chunk-GREZN6PE.js";
import {
  ListItemButton_default,
  StyledListItemButton,
  getListItemButtonUtilityClass,
  listItemButtonClasses_default
} from "./chunk-U5MDSH6N.js";
import {
...
} from "./chunk-KU73FPXM.js";
import "./chunk-JEEBJ3UW.js";
import {
  applySoftInversion,
  applySolidInversion
} from "./chunk-FKAWZOXX.js";
import {
  Link_default,
  getLinkUtilityClass,
  linkClasses_default
} from "./chunk-COXQI67R.js";
import {
...
} from "./chunk-TKDP7KXV.js";
import {
  FormControl_default,
  formControlClasses_default,
  getFormControlUtilityClass
} from "./chunk-CXW3B2AE.js";
import {
  getSwitchUtilityClass,
  switchClasses_default
} from "./chunk-BJSH26IA.js";
import {
  FormControlContext_default
} from "./chunk-OQ2TUDNA.js";
import {
  Button_default,
  getButtonStyles
} from "./chunk-7C3BWQMJ.js";
import {
  buttonClasses_default,
  getButtonUtilityClass
} from "./chunk-GP2IALV7.js";
import {
  ToggleButtonGroupContext_default
} from "./chunk-FRYRXDPI.js";
import {
...
import {
  ...
  useSlider,
  valueToPercent
} from "./chunk-AYH7OM5B.js";
import {
  useSwitch
} from "./chunk-2L3AULM5.js";
import {
  FocusTrap,
  Portal,
  useModal
} from "./chunk-YMTQ26QR.js";
import {
  ListActionTypes,
  ListContext
} from "./chunk-K4KSSRQS.js";
import "./chunk-WFGKNONG.js";
import "./chunk-3CRIPPDR.js";
import "./chunk-O2VKXX75.js";
import {
  useSlot
...
import {
  ...
  useColorScheme,
  useTheme
} from "./chunk-7DEZ6AQW.js";
import {
  styled_default,
  useThemeProps
} from "./chunk-P3J73K2K.js";
import {
  colors_default,
  createContainer,
...
var Accordion = React2.forwardRef(function Accordion2(inProps, ref) {
  ...
  return (0, import_jsx_runtime.jsx)(AccordionContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime.jsx)(SlotRoot, _extends({}, rootProps, {
      children: React2.Children.map(children, (child, index) => React2.isValidElement(child) && index === 0 ? React2.cloneElement(child, {
...
var AccordionDetails = React3.forwardRef(function AccordionDetails2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyAccordionDetails"
  });
  ...
  const {
    accordionId,
    expanded = false
  } = React3.useContext(AccordionContext_default);
  ...
  return (0, import_jsx_runtime2.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime2.jsx)(SlotContent, _extends({}, contentProps, {
      children
    }))
  }));
});
...
var KeyboardArrowDown_default = createSvgIcon((0, import_jsx_runtime4.jsx)("path", {
...
var AccordionSummary = React6.forwardRef(function AccordionSummary2(inProps, ref) {
  ...
  const {
    ...
    color = "neutral",
    children,
    indicator = _KeyboardArrowDown || (_KeyboardArrowDown = (0, import_jsx_runtime5.jsx)(KeyboardArrowDown_default, {})),
    variant = "plain",
    slots = {},
    slotProps = {}
  ...
  return (
    ...
    (0, import_jsx_runtime5.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime6.jsxs)(SlotButton, _extends({}, buttonProps, {
        children: [children, indicator && (0, import_jsx_runtime5.jsx)(SlotIndicator, _extends({}, indicatorProps, {
          children: indicator
        }))]
      }))
    }))
...
var _excluded5 = ["anchorOrigin", "badgeInset", "children", "size", "color", "invisible", "max", "badgeContent", "showZero", "variant", "component", "slots", "slotProps"];
...
var Badge = React7.forwardRef(function Badge2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [children, (0, import_jsx_runtime7.jsx)(SlotBadge, _extends({}, badgeProps, {
...
true ? Badge.propTypes = {
   ...
   * @default 0
   */
  badgeInset: import_prop_types5.default.oneOfType([import_prop_types5.default.number, import_prop_types5.default.string]),
  /**
...
var _excluded6 = ["children", "className", "size", "separator", "component", "slots", "slotProps"];
...
var Breadcrumbs = React8.forwardRef(function Breadcrumbs2(inProps, ref) {
  ...
  const allItems = React8.Children.toArray(children).filter((child) => {
    ...
    return (0, import_jsx_runtime9.jsx)(SlotLi, _extends({}, liProps, {
      children: isMuiElement(child, ["Typography"]) ? React8.cloneElement(child, {
        component: (_child$props$componen = child.props.component) != null ? _child$props$componen : "span"
      }) : child
    }), `child-${index}`);
  });
  return (0, import_jsx_runtime9.jsx)(TypographyInheritContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime9.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime9.jsx)(SlotOl, _extends({}, olProps, {
        children: allItems.reduce((acc, current, index) => {
          if (index < allItems.length - 1) {
            acc = acc.concat(current, (0, import_jsx_runtime9.jsx)(SlotSeparator, _extends({}, separatorProps, {
              children: separator
            }), `separator-${index}`));
          } else {
            acc.push(current);
...
true ? Breadcrumbs.propTypes = {
  ...
  slotProps: import_prop_types6.default.shape({
    li: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
    ol: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
    root: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
    separator: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types6.default.shape({
    li: import_prop_types6.default.elementType,
    ol: import_prop_types6.default.elementType,
    root: import_prop_types6.default.elementType,
    separator: import_prop_types6.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded7 = ["className", "component", "children", "slots", "slotProps"];
...
var CardCover = React9.forwardRef(function CardCover2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyCardCover"
  });
...
var _excluded8 = ["component", "children", "buttonFlex", "orientation", "slots", "slotProps"];
...
true ? DialogActions.propTypes = {
   ...
   */
  buttonFlex: import_prop_types9.default.oneOfType([import_prop_types9.default.number, import_prop_types9.default.string]),
  /**
   ...
   */
  orientation: import_prop_types9.default.oneOf(["horizontal-reverse", "horizontal", "vertical"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
var _excluded9 = ["component", "children", "orientation", "slots", "slotProps"];
...
var DialogContent = React11.forwardRef(function DialogContent2(inProps, ref) {
  ...
  const context = React11.useContext(ModalDialogVariantColorContext_default);
  const {
    component = "div",
    children,
...
var _excluded10 = ["component", "children", "variant", "color", "level", "slots", "slotProps"];
...
var DialogTitle = React12.forwardRef(function DialogTitle2(inProps, ref) {
  ...
  const size = React12.useContext(ModalDialogSizeContext_default);
  const context = React12.useContext(ModalDialogVariantColorContext_default);
  const {
    component = "h2",
    children,
    variant,
...
true ? DialogTitle.propTypes = {
   ...
   */
  level: import_prop_types11.default.oneOf(["body-lg", "body-md", "body-sm", "body-xs", "h1", "h2", "h3", "h4", "inherit", "title-lg", "title-md", "title-sm"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
...
var _excluded11 = ["children", "anchor", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "color", "variant", "invertedColors", "size", "onClose", "onKeyDown", "open", "component", "slots", "slotProps"];
...
var Drawer = React13.forwardRef(function Drawer2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyDrawer"
  });
  ...
  return (0, import_jsx_runtime14.jsx)(CloseModalContext_default.Provider, {
    value: onClose,
    children: (0, import_jsx_runtime14.jsx)(ModalDialogSizeContext_default.Provider, {
      value: size,
      children: (0, import_jsx_runtime14.jsx)(ModalDialogVariantColorContext_default.Provider, {
        value: contextValue,
        children: (0, import_jsx_runtime14.jsx)(Portal, {
          ref: portalRef,
          container,
          disablePortal,
          children: (0, import_jsx_runtime15.jsxs)(SlotRoot, _extends({}, rootProps, {
            children: [!hideBackdrop ? (0, import_jsx_runtime14.jsx)(SlotBackdrop, _extends({}, backdropProps)) : null, (0, import_jsx_runtime14.jsx)(FocusTrap, {
              disableEnforceFocus,
              disableAutoFocus,
              disableRestoreFocus,
              isEnabled: isTopModal,
              open,
              children: (0, import_jsx_runtime14.jsx)(SlotContent, _extends({}, contentProps, {
                children
              }))
            })]
          }))
...
true ? Drawer.propTypes = {
   ...
   * @default 'left'
   */
  anchor: import_prop_types12.default.oneOf(["bottom", "left", "right", "top"]),
  /**
   * @ignore
   */
   ...
   * @default 'neutral'
   */
  color: import_prop_types12.default.oneOf(["danger", "neutral", "primary", "success", "warning"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  invertedColors: import_prop_types12.default.bool,
  /**
   ...
   * @default 'md'
   */
  size: import_prop_types12.default.oneOf(["sm", "md", "lg"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
   ...
   * @default 'plain'
   */
  variant: import_prop_types12.default.oneOf(["outlined", "plain", "soft", "solid"])
} : void 0;
...
var _excluded12 = ["children", "component", "slots", "slotProps"];
...
var FormHelperText = React14.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  const handleRef = useForkRef(rootRef, ref);
  const formControl = React14.useContext(FormControlContext_default);
...
var _excluded13 = ["actions", "children", "color", "component", "disablePortal", "keepMounted", "id", "invertedColors", "onItemsChange", "modifiers", "variant", "size", "slots", "slotProps"];
...
var Menu = React15.forwardRef(function Menu2(inProps, ref) {
  ...
  const modifiers = React15.useMemo(() => [{
    name: "offset",
    options: {
      offset: [0, 4]
    }
  ...
  return (0, import_jsx_runtime17.jsx)(MenuRoot, _extends({}, rootProps, !((_props$slots = props.slots) != null && _props$slots.root) && {
    as: Popper,
    slots: {
      root: component || "ul"
    }
    ...
    children: (0, import_jsx_runtime17.jsx)(MenuProvider, {
      value: contextValue,
      children: (0, import_jsx_runtime17.jsx)(VariantColorProvider, {
        variant: invertedColors ? void 0 : variant,
        color,
        children: (0, import_jsx_runtime17.jsx)(GroupListContext_default.Provider, {
          value: "menu",
          children: (0, import_jsx_runtime17.jsx)(ListProvider_default, {
            nested: true,
            children
          })
        })
...
true ? Menu.propTypes = {
   ...
   * @default 'neutral'
   */
  color: import_prop_types14.default.oneOf(["danger", "neutral", "primary", "success", "warning"]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  invertedColors: import_prop_types14.default.bool,
  /**
...
var _excluded14 = ["children", "color", "component", "disabled", "endDecorator", "loading", "loadingPosition", "loadingIndicator", "size", "slotProps", "slots", "startDecorator", "variant"];
...
var MenuButton = React16.forwardRef(function MenuButton2(inProps, forwardedRef) {
  ...
  const buttonGroup = React16.useContext(ButtonGroupContext_default);
  ...
  const loadingIndicator = loadingIndicatorProp != null ? loadingIndicatorProp : (0, import_jsx_runtime18.jsx)(CircularProgress_default, {
    color,
    thickness: {
      sm: 2,
      md: 3,
  ...
  return (0, import_jsx_runtime19.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(startDecorator || loading && loadingPosition === "start") && (0, import_jsx_runtime18.jsx)(SlotStartDecorator, _extends({}, startDecoratorProps, {
      children: loading && loadingPosition === "start" ? loadingIndicator : startDecorator
    })), children, loading && loadingPosition === "center" && (0, import_jsx_runtime18.jsx)(SlotLoadingIndicatorCenter, _extends({}, loadingIndicatorCenterProps, {
      children: loadingIndicator
    })), (endDecorator || loading && loadingPosition === "end") && (0, import_jsx_runtime18.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
...
true ? MenuButton.propTypes = {
  ...
  slotProps: import_prop_types15.default.shape({
    ...
    loadingIndicatorCenter: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
  ...
  slots: import_prop_types15.default.shape({
    ...
    loadingIndicatorCenter: import_prop_types15.default.elementType,
...
var _excluded15 = ["children", "disabled", "component", "selected", "color", "orientation", "variant", "slots", "slotProps", "id"];
...
var MenuItem = React17.memo(React17.forwardRef(function MenuItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyMenuItem"
  });
  ...
  return (0, import_jsx_runtime20.jsx)(ListItemButtonOrientationContext_default.Provider, {
    value: orientation,
    children: (0, import_jsx_runtime20.jsx)(SlotRoot, _extends({}, rootProps, {
      children
    }))
  });
}));
var StableMenuItem = React17.forwardRef(function StableMenuItem2(props, ref) {
  const {
    contextValue,
    id
  ...
  return (0, import_jsx_runtime20.jsx)(ListContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime20.jsx)(MenuItem, _extends({}, props, {
      id,
      ref
    }))
  });
...
var _excluded16 = ["actions", "id", "component", "children", "size", "variant", "color", "onItemsChange", "slots", "slotProps"];
...
var MenuList = React18.forwardRef(function MenuList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyMenuList"
  });
  ...
  return (0, import_jsx_runtime21.jsx)(SlotRoot, _extends({}, rootProps, {
    children: (0, import_jsx_runtime21.jsx)(MenuProvider, {
      ...
      children: (0, import_jsx_runtime21.jsx)(GroupListContext_default.Provider, {
        value: "menu",
...
true ? MenuList.propTypes = {
   ...
   * Function called when the items displayed in the menu change.
   */
  onItemsChange: import_prop_types17.default.func,
  /**
   * The size of the component (affect other nested list* components because the `Menu` inherits `List`).
   * @default 'md'
   */
...
var _excluded17 = ["children", "onClick"];
...
var ModalOverflow = React19.forwardRef(function ModalOverflow2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyModalOverflow"
  });
  ...
  const onClose = React19.useContext(CloseModalContext_default);
...
var _excluded18 = ["checked", "checkedIcon", "defaultChecked", "disabled", "disableIcon", "overlay", "label", "id", "name", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "color", "variant", "size", "uncheckedIcon", "value", "component", "slots", "slotProps"];
...
var Radio = React20.forwardRef(function Radio2(inProps, ref) {
  ...
  const radioGroup = React20.useContext(RadioGroupContext_default);
  ...
  return (0, import_jsx_runtime24.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime24.jsxs)(SlotRadio, _extends({}, radioProps, {
      children: [checked && !disableIcon && checkedIcon, !checked && !disableIcon && uncheckedIcon, !checkedIcon && !uncheckedIcon && !disableIcon && (0, import_jsx_runtime23.jsx)(SlotIcon, _extends({}, iconProps)), (0, import_jsx_runtime23.jsx)(SlotAction, _extends({}, actionProps, {
        children: (0, import_jsx_runtime23.jsx)(SlotInput, _extends({}, inputProps))
      }))]
    })), label && (0, import_jsx_runtime23.jsx)(SlotLabel, _extends({}, labelProps, {
      children: (0, import_jsx_runtime23.jsx)(TypographyNestedContext.Provider, {
        value: true,
        children: label
      })
    }))]
...
true ? Radio.propTypes = {
   ...
   * @default 'neutral'
   */
  color: import_prop_types19.default.oneOfType([import_prop_types19.default.oneOf(["danger", "primary", "success", "warning"]), import_prop_types19.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableIcon: import_prop_types19.default.bool,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  overlay: import_prop_types19.default.bool,
  /**
  ...
  slotProps: import_prop_types19.default.shape({
    ...
    icon: import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.object]),
    ...
    radio: import_prop_types19.default.oneOfType([import_prop_types19.default.func, import_prop_types19.default.object]),
   ...
   */
  uncheckedIcon: import_prop_types19.default.node,
  /**
...
var _excluded19 = ["className", "component", "children", "name", "defaultValue", "disableIcon", "overlay", "value", "onChange", "color", "variant", "size", "orientation", "role", "slots", "slotProps"];
...
var RadioGroup = React21.forwardRef(function RadioGroup2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyRadioGroup"
  });
  ...
  return (0, import_jsx_runtime25.jsx)(RadioGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime25.jsx)(SlotRoot, _extends({}, rootProps, {
      children: (0, import_jsx_runtime25.jsx)(FormControlContext_default.Provider, {
        value: void 0,
        children: React21.Children.map(children, (child, index) => React21.isValidElement(child) ? React21.cloneElement(child, _extends({}, index === 0 && {
          "data-first-child": ""
        }, index === React21.Children.count(children) - 1 && {
          "data-last-child": ""
        }, {
...
true ? RadioGroup.propTypes = {
   ...
   * @default 'neutral'
   */
  color: import_prop_types20.default.oneOfType([import_prop_types20.default.oneOf(["danger", "primary", "success", "warning"]), import_prop_types20.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableIcon: import_prop_types20.default.bool,
  /**
   ...
   * @default false
   */
  overlay: import_prop_types20.default.bool,
  /**
   * @ignore
   */
...
var _excluded20 = ["className", "component", "disableColorScheme", "slots", "slotProps"];
...
var ScopedCssBaseline = React22.forwardRef(function ScopedCssBaseline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyScopedCssBaseline"
  });
...
var _excluded21 = ["className", "component", "children", "animation", "overlay", "loading", "variant", "level", "height", "width", "sx", "slots", "slotProps"];
var _ = (t) => t;
var _t;
var _t2;
var _t3;
...
var Skeleton = React23.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return loading ? (0, import_jsx_runtime27.jsx)(SlotRoot, _extends({}, rootProps, {
    children
  })) : (0, import_jsx_runtime27.jsx)(React23.Fragment, {
...
true ? Skeleton.propTypes = {
   ...
   * @default 'pulse'
   */
  animation: import_prop_types22.default.oneOf(["pulse", "wave", false]),
  /**
   ...
   */
  height: import_prop_types22.default.oneOfType([import_prop_types22.default.arrayOf(import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string])), import_prop_types22.default.number, import_prop_types22.default.shape({
   ...
   * @default false
   */
  overlay: import_prop_types22.default.bool,
  /**
   * The props used for each slot inside.
   * @default {}
   */
   ...
   * @default 'overlay'
   */
  variant: import_prop_types22.default.oneOfType([import_prop_types22.default.oneOf(["circular", "inline", "overlay", "rectangular", "text"]), import_prop_types22.default.string]),
  /**
   * Width of the skeleton.
   * Useful when the skeleton is inside an inline element with no width of its own.
   */
  width: import_prop_types22.default.oneOfType([import_prop_types22.default.arrayOf(import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string])), import_prop_types22.default.number, import_prop_types22.default.shape({
    lg: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string]),
    md: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string]),
    sm: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string]),
    xl: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string]),
...
var _excluded22 = ["aria-label", "aria-valuetext", "className", "classes", "disableSwap", "disabled", "defaultValue", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "shiftStep", "scale", "step", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat", "isRtl", "color", "size", "variant", "component", "slots", "slotProps"];
function Identity(x) {
  return x;
}
...
var Slider = React24.forwardRef(function Slider2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoySlider"
  });
  ...
  return (0, import_jsx_runtime29.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(SlotRail, _extends({}, railProps)), (0, import_jsx_runtime28.jsx)(SlotTrack, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime29.jsxs)(React24.Fragment, {
        children: [(0, import_jsx_runtime28.jsx)(SlotMark, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime28.jsx)(SlotMarkLabel, _extends({
          "data-index": index
        }, markLabelProps, {
      ...
      const style = axisProps[axis].offset(percent);
      return (0, import_jsx_runtime29.jsxs)(SlotThumb, _extends({
        "data-index": index
      }, thumbProps, {
        ...
        children: [(0, import_jsx_runtime28.jsx)(SlotInput, _extends({
          "data-index": index,
          "aria-label": getAriaLabel ? getAriaLabel(index) : ariaLabel,
          "aria-valuenow": scale(value),
          "aria-valuetext": getAriaValueText ? getAriaValueText(scale(value), index) : ariaValuetext,
          value: values[index]
        }, inputProps)), valueLabelDisplay !== "off" ? (0, import_jsx_runtime28.jsx)(SlotValueLabel, _extends({}, valueLabelProps, {
...
true ? Slider.propTypes = {
   ...
   */
  "aria-valuetext": import_prop_types23.default.string,
  /**
   * @ignore
   */
  ...
  slotProps: import_prop_types23.default.shape({
    ...
    valueLabel: import_prop_types23.default.oneOfType([import_prop_types23.default.func, import_prop_types23.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
   ...
   * @default 'off'
   */
  valueLabelDisplay: import_prop_types23.default.oneOf(["auto", "off", "on"]),
  /**
...
var _excluded23 = ["className", "component", "size", "children", "orientation", "slots", "slotProps"];
...
var Stepper = React25.forwardRef(function Stepper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyStepper"
  });
...
var _excluded24 = ["active", "completed", "className", "component", "children", "disabled", "orientation", "indicator", "slots", "slotProps"];
...
var Step = React26.forwardRef(function Step2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyStep"
  });
  ...
  return (0, import_jsx_runtime32.jsxs)(SlotRoot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime31.jsx)(SlotIndicator, _extends({}, indicatorProps, {
      children: indicator
    })), children]
  }));
});
true ? Step.propTypes = {
   ...
   * @default false
   */
  completed: import_prop_types25.default.bool,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  indicator: import_prop_types25.default.node,
  /**
   * The component orientation.
   * @default 'horizontal'
   */
  ...
  slotProps: import_prop_types25.default.shape({
    indicator: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
  ...
  slots: import_prop_types25.default.shape({
    indicator: import_prop_types25.default.elementType,
...
var _excluded25 = ["className", "component", "children", "slots", "slotProps"];
...
var StepButton = React27.forwardRef(function StepButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyStepButton"
  });
...
var _excluded26 = ["className", "component", "color", "children", "variant", "slots", "slotProps"];
...
var StepIndicator2 = React28.forwardRef(function StepIndicator3(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyStepIndicator"
  });
...
var _excluded27 = ["buttonFlex", "className", "component", "disabled", "size", "color", "variant", "children", "onChange", "orientation", "slots", "slotProps", "spacing", "value"];
...
var ToggleButtonGroup = React29.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "JoyToggleButtonGroup"
  });
  ...
  const buttonGroupContext = React29.useMemo(() => ({
    variant,
    color,
    size,
    disabled
  ...
  const toggleButtonGroupContext = React29.useMemo(() => ({
...
true ? ToggleButtonGroup.propTypes = {
   ...
   */
  buttonFlex: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
  /**
   ...
   * @default 'md'
   */
  size: import_prop_types28.default.oneOf(["sm", "md", "lg"]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
   ...
   * @default 0
   */
  spacing: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string])), import_prop_types28.default.number, import_prop_types28.default.shape({
    lg: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    md: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    sm: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    xl: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string]),
    xs: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string])
   ...
   */
  value: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.string), import_prop_types28.default.string]),
  /**
   * The [global variant](https://mui.com/joy-ui/main-features/global-variants/) to use.
   * @default 'outlined'
   */
