...
var Tooltip = React.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const prevUserSelect = React.useRef(void 0);
  ...
  return (0, import_jsx_runtime2.jsxs)(React.Fragment, {
    children: [React.isValidElement(children) && React.cloneElement(children, childrenProps), (0, import_jsx_runtime2.jsxs)(SlotRoot, _extends({}, rootProps, !((_props$slots = props.slots) != null && _props$slots.root) && {
      as: Popper,
      slots: {
        root: component || "div"
      }
...
//# sourceMappingURL=chunk-BG2THGNB.js.map
