...
function useSlider(parameters) {
  ...
  const touchId = React14.useRef(void 0);
  ...
  const previousIndex = React14.useRef(void 0);
...
var Tabs = React19.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React20.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React21.useCallback((tabValue) => {
    var _subitems$get;
  ...
  const getTabElement = React21.useCallback((tabValue) => {
  ...
  const handleChange = React21.useCallback((event, newValue) => {
    var _newValue$;
  ...
  const isItemDisabled = React21.useCallback((item) => {
  ...
  const {
    ...
    reducerActionContext: React21.useMemo(() => ({
  ...
  const contextValue = React21.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
function useTab(parameters) {
  ...
  const tabRef = React23.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
...
var Badge = React24.forwardRef(function Badge2(props, forwardedRef) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime26.jsx)(React42.Fragment, {
...
var Select = React42.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React42.Fragment, {
...
var Slider = React43.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime28.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime29.jsxs)(React43.Fragment, {
...
var TabPanel = React48.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var Tab = React50.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
function CssAnimation(props) {
  ...
  const hasExited = React51.useRef(true);
  React51.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React51.useCallback((event) => {
...
var CssTransition = React52.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React52.useState(false);
  React52.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React52.useCallback((event) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JHX7BLFA.js.map
