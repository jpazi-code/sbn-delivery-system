...
function useOption(params) {
  ...
  const optionRef = React8.useRef(null);
  const selectOption = React8.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
function useOptionContextStabilizer(value) {
  const listContext = React9.useContext(ListContext);
  if (!listContext) {
  ...
  const localGetItemState = React9.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React9.useMemo(() => ({
    dispatch,
...
//# sourceMappingURL=chunk-32GVBUPJ.js.map
