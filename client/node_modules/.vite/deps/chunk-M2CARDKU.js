...
var ModalClose = React.forwardRef(function ModalClose2(inProps, ref) {
  ...
  const closeModalContext = React.useContext(CloseModalContext_default);
  const modalDialogVariantColor = React.useContext(ModalDialogVariantColorContext_default);
  ...
  const modalDialogSize = React.useContext(ModalDialogSizeContext_default);
...
//# sourceMappingURL=chunk-M2CARDKU.js.map
