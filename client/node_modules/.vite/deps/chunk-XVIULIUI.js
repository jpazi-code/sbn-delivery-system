...
var Unfold_default = createSvgIcon((0, import_jsx_runtime.jsx)("path", {
...
var Select = React2.forwardRef(function Select2(inProps, ref) {
  ...
  const _ref = props, {
    ...
    startDecorator,
    endDecorator,
    indicator = _Unfold || (_Unfold = (0, import_jsx_runtime2.jsx)(Unfold_default, {})),
  ...
  const selectedOption = React2.useMemo(() => {
  ...
  const modifiers = React2.useMemo(() => [...defaultModifiers, ...listboxProps.modifiers || []], [listboxProps.modifiers]);
  ...
  return (0, import_jsx_runtime3.jsxs)(React2.Fragment, {
    children: [(0, import_jsx_runtime3.jsxs)(SlotRoot, _extends({}, rootProps, {
      ...
      })), (0, import_jsx_runtime2.jsx)(SlotButton, _extends({}, buttonProps, {
        children: displayValue
      })), endDecorator && (0, import_jsx_runtime2.jsx)(SlotEndDecorator, _extends({}, endDecoratorProps, {
        children: endDecorator
      })), indicator && (0, import_jsx_runtime2.jsx)(SlotIndicator, _extends({}, indicatorProps, {
        children: indicator
      })), (0, import_jsx_runtime2.jsx)("input", _extends({}, getHiddenInputProps()))]
    })), anchorEl && (0, import_jsx_runtime2.jsx)(SlotListbox, _extends({}, listboxProps, {
      ...
      children: (0, import_jsx_runtime2.jsx)(SelectProvider, {
        value: contextValue,
        children: (0, import_jsx_runtime2.jsx)(VariantColorProvider, {
          variant,
          color: colorProp,
          children: (0, import_jsx_runtime2.jsx)(GroupListContext_default.Provider, {
            value: "select",
...
true ? Select.propTypes = {
   ...
   * @default false
   */
  defaultListboxOpen: import_prop_types.default.bool,
  /**
   ...
   */
  getSerializedValue: import_prop_types.default.func,
  /**
   ...
   */
  listboxId: import_prop_types.default.string,
  /**
   * Controls the open state of the select's listbox.
   * @default undefined
   */
  listboxOpen: import_prop_types.default.bool,
  /**
   ...
   */
  onListboxOpenChange: import_prop_types.default.func,
  /**
   * Text to show when there is no selected value.
   */
  placeholder: import_prop_types.default.node,
  /**
...
//# sourceMappingURL=chunk-XVIULIUI.js.map
